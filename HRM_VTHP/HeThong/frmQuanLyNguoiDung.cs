    ...
    public partial class frmQuanLyNguoiDung : Form
    {
        ...
        private void btnCapNhat_Click(object sender, EventArgs e)
        {
            if(kt == 1)
            {
                ...
                {
                    string sql = "Insert into NguoiDung(TenDangNhap, MatKhau, QuanTri, NhanVienID) values ('" + txtTenDangNhap.Text + "', '" + txtMatKhau.Text + "', '"+cbQuanTri.Checked+"', " + cmbNhanVien.SelectedValue + ")";
            ...
            {
                string sql = "Update NguoiDung set TenDangNhap = '" + txtTenDangNhap.Text + "', MatKhau = '" + txtMatKhau.Text + "', QuanTri = '" + cbQuanTri.Checked + "', NhanVienID = " + cmbNhanVien.SelectedValue + " where NguoiDungID = '"+NguoiDungID+"'";
